...
| Aspect | Current ViPE | `instance_bench` ViPE with TSDF enabled | CHOICE4 |
|---|---|---|---|
...
| Parameter | Current ViPE | `instance_bench` ViPE | CHOICE4 |
|---|---:|---:|---|
| Graph buffer | 1024 | 2048 | 1024 |
| Forced keyframe gap | 16 frames | 8 frames | 8 frames |
| Warmup optimization | `2 updates x 2 BA iters = 4` cycles | `8 x 3 = 24` cycles | `2 x 2 = 4` cycles |
| Per-keyframe frontend maximum | `(3 + 2) x 2 = 10` cycles | `(4 + 2) x 3 = 18` cycles | `(3 + 2) x 2 = 10` cycles |
| Backend optimization | `17 x 5 = 85` cycles | `31 x 8 = 248` cycles | `17 x 5 = 85` cycles |
| Infill optimization per chunk | `4 x 2 = 8` cycles | `10 x 3 = 30` cycles; inner count is the code default | `4 x 2 = 8` cycles |
